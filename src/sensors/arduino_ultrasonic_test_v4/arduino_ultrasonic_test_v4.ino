...
//sonic1
int triggerPin = 11;      //Define IO pinsr
int echoPin = 13;
...
void loop()
{
  ...
  Serial.print("{""US1"": ");        //Display the distance on the serial monitor
  Serial.print(distance1);
  Serial.print(", ");
  Serial.print("""US2"": ");        //Display the distance on the serial monitor
  Serial.print(distance2);
  Serial.print(", ");
  Serial.print("""US3"": ");        //Display the distance on the serial monitor
